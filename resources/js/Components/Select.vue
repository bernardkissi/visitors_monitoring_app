    ...
    <div class="w-full">
        <Combobox v-model="selected">
            <div class="relative mt-1">
                <div class="relative w-full text-left bg-white rounded-md cursor-default sm:text-sm overflow-hidden">
                    <ComboboxInput
                        class="w-full border border-gray-300 focus:ring-0 py-4 pl-3 pr-10 text-sm leading-5 text-gray-900"
